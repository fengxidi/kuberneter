...
func NewOptions() *Options {
	o := &Options{
		...
		Metrics: metrics.NewOptions(), // 开启指标监控
		Logs:    logs.NewOptions(),    // 初始化 日志处理
	}

	o.Authentication.TolerateInClusterLookupFailure = true // 容忍集群内查找失败
	o.Authentication.RemoteKubeConfigFileOptional = true   // 运行远程获取kubeconfig文件
	o.Authorization.RemoteKubeConfigFileOptional = true    // 远程KubeConfig文件可选
...
func (o *Options) ApplyTo(c *schedulerappconfig.Config) error {
	...
	// 设置 PodMaxInUnschedulablePodsDuration 参数
